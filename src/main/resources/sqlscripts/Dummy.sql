...
(1,'이천쌀','1','2','1','1','20kg','햅쌀',1000000,'2019-06-01',909091,90909,0.1,0,0,'true','s001'),
(2,'이천쌀','1','2','1','1','10kg','햅쌀',2000000,'2019-06-01',909091,90909,0.1,0,0,'true','s001'),
(3,'이천쌀','1','2','1','1','15kg','햅쌀',800000,'2019-06-01',909091,90909,0.1,0,0,'true','s001'),
(4,'이천쌀','1','2','1','1','40kg','햅쌀',4000000,'2019-06-01',909091,90909,0.1,0,0,'true','s001'),

(5,'김포쌀','1','2','2','2','5kg','햅쌀',1000000,'2019-05-02',1909091,190909,0.1,4,2,'true','s003'),
(6,'김포쌀','1','2','2','2','5kg','묵은쌀',100000,'2019-05-02',1909091,190909,0.1,4,2,'true','s003'),
(7,'김포쌀','1','2','2','2','10kg','묵은쌀',12000000,'2019-05-02',1909091,190909,0.1,4,2,'true','s003'),
(8,'김포쌀','1','2','2','2','10kg','햅쌀',200000,'2019-05-02',1909091,190909,0.1,4,2,'true','s003'),
(9,'김포쌀','1','2','2','2','15kg','햅쌀',2500000,'2019-05-02',1909091,190909,0.1,4,2,'true','s003'),
(10,'김포쌀','1','2','2','2','20kg','묵은쌀',3000000,'2019-05-02',1909091,190909,0.1,4,2,'true','s003'),

(11,'멸치','2','1','3','3','1kg','null',23000,'2019-08-01',20000,909,0.1,200,2,'true','s001'),
(12,'멸치','2','1','3','3','2kg','null',33000,'2019-08-01',20000,909,0.1,200,2,'true','s001'),
(13,'멸치','2','1','3','3','3kg','null',43000,'2019-08-01',20000,909,0.1,200,2,'true','s001'),
(14,'멸치','2','1','3','3','4kg','null',53000,'2019-08-01',20000,909,0.1,200,2,'true','s001'),
(15,'멸치','2','1','3','3','5kg','null',63000,'2019-08-01',20000,909,0.1,200,2,'true','s001'),


(16,'키조개','2','2','4','4','2kg','2cm',22000,'2019-07-22',19000,2909,0.1,5,3,'true','s002'),
(17,'키조개','2','2','4','4','2kg','3cm',32000,'2019-07-22',19000,2909,0.1,5,3,'true','s002'),
(18,'키조개','2','2','4','4','2kg','4cm',42000,'2019-07-22',19000,2909,0.1,5,3,'true','s002'),
(19,'키조개','2','2','4','4','2kg','10cm',52000,'2019-07-22',19000,2909,0.1,5,3,'true','s002'),
(20,'키조개','2','2','4','4','2kg','24cm',62000,'2019-07-22',19000,2909,0.1,5,3,'true','s002'),
(21,'키조개','2','2','4','4','2kg','30cm',72000,'2019-07-22',19000,2909,0.1,5,3,'true','s002'),

(22,'등심','3','1','5','5','0.6kg',null,33000,'2019-06-22',30000,1909,0.1,6,12,'true','s003'),
(23,'등심','3','1','5','5','1kg',null,43000,'2019-06-22',30000,1909,0.1,6,12,'true','s003'),
(24,'등심','3','1','5','5','2kg',null,53000,'2019-06-22',30000,1909,0.1,6,12,'true','s003'),
(25,'등심','3','1','5','5','3kg',null,63000,'2019-06-22',30000,1909,0.1,6,12,'true','s003'),
(26,'등심','3','1','5','5','4kg',null,73000,'2019-06-22',30000,1909,0.1,6,12,'true','s003'),
(27,'등심','3','1','5','5','5kg',null,83000,'2019-06-22',30000,1909,0.1,6,12,'true','s003'),

(28,'삽겹살','3','2','6','6','1kg','냉동',33000,'2019-07-12',20000,909,0.1,7,1,'true','s002'),
(29,'삽겹살','3','2','6','6','1kg','냉장',33000,'2019-07-12',20000,909,0.1,7,1,'true','s002'),
(30,'목살','3','2','6','6','1kg','냉동',33000,'2019-07-12',20000,909,0.1,7,1,'true','s002'),
(31,'목살','3','2','6','6','1kg','냉장',33000,'2019-07-12',20000,909,0.1,7,1,'true','s002');
